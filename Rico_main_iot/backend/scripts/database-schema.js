...
const REQUIRED_COLUMNS = {
  ...
  PlcCycleReadings: [
    ...
    "die_close_core_in_time_status", "pouring_time_status", "shot_fwd_time_status", "curing_time_status",
    "die_open_core_out_time_status", "ejector_time_status", "extract_time_status", "spray_time_status",
    "v1_speed_status", "v2_speed_status", "v3_speed_status", "v4_speed_status", "metal_pressure_status",
    "furnace_metal_temp_status", "cooling_water_mov_status", "cooling_water_sta_status", "accel_point_status",
    "deaccel_point_status", "intensification_time_status", "biscuit_thickness_status", "jet_cooling_pressure_status",
    "clamp_tonnage_he_low_pct_status", "clamp_tonnage_he_low_mn_status", "clamp_tonnage_op_up_pct_status",
    "clamp_tonnage_op_low_pct_status", "clamp_tonnage_he_up_pct_status", "vacuum_pressure_status",
