...
DECLARE @ube_register_config NVARCHAR(MAX) = N'[
  ...
  {"name":"Cycle Start","device":"M840","type":"int","scale":1,"enabled":false,"show_on_monitor":false,"log_history":false,"group":"Machine Signals","unit":""},
  {"name":"Cycle End","device":"M4598","type":"int","scale":1,"enabled":false,"show_on_monitor":false,"log_history":false,"group":"Machine Signals","unit":""},
