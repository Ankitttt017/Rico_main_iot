...
const HIDDEN_COLUMNS = new Set([
  ...
  "clamp_tonnage_lower_limit",
  "clamp_tonnage_upper_limit",
  "raw_readings_json",
  "created_at",
  "machine_type",
  "has_data",
...
const REPORT_LABELS = {
  ...
  die_close_core_in_time_upper_limit: "Die-Close Core In Time Upper Limit",
  die_close_core_in_time_lower_limit: "Die-Close Core In Time Lower Limit",
  shot_fwd_time: "Shot FWD Time",
  pouring_time_upper_limit: "Pouring Time Upper Limit",
  pouring_time_lower_limit: "Pouring Time Lower Limit",
  shot_fwd_time_upper_limit: "Shot FWD Time Upper Limit",
  shot_fwd_time_lower_limit: "Shot FWD Time Lower Limit",
  curing_time: "Curing Time (Cooling Time)",
  curing_time_upper_limit: "Curing Time Upper Limit",
  curing_time_lower_limit: "Curing Time Lower Limit",
  die_open_core_out_time: "Die Open Core Out Time",
  die_open_core_out_time_upper_limit: "Die Open Core Out Time Upper Limit",
  die_open_core_out_time_lower_limit: "Die Open Core Out Time Lower Limit",
  extract_time: "Extract Time",
  ejector_time_upper_limit: "Ejector Time Upper Limit",
  ejector_time_lower_limit: "Ejector Time Lower Limit",
  extract_time_upper_limit: "Extract Time Upper Limit",
  extract_time_lower_limit: "Extract Time Lower Limit",
  spray_time_upper_limit: "Spray Time Upper Limit",
  spray_time_lower_limit: "Spray Time Lower Limit",
  v1_speed: "V1",
  v1_speed_upper_limit: "V1 Upper Limit",
  v1_speed_lower_limit: "V1 Lower Limit",
  v2_speed: "V2",
  v2_speed_upper_limit: "V2 Upper Limit",
  v2_speed_lower_limit: "V2 Lower Limit",
  v3_speed: "V3",
  v3_speed_upper_limit: "V3 Upper Limit",
  v3_speed_lower_limit: "V3 Lower Limit",
  v4_speed: "V4",
  v4_speed_upper_limit: "V4 Upper Limit",
  v4_speed_lower_limit: "V4 Lower Limit",
  metal_pressure: "Metal Press.",
  metal_pressure_upper_limit: "Metal Press. Upper Limit",
  metal_pressure_lower_limit: "Metal Press. Lower Limit",
  furnace_metal_temp: "Furnace Metal Temp.",
  furnace_metal_temp_upper_limit: "Furnace Metal Temp. Upper Limit",
  furnace_metal_temp_lower_limit: "Furnace Metal Temp. Lower Limit",
  cooling_water_mov: "Cooling Water Flow Rate (Mov.)",
  cooling_water_mov_upper_limit: "Cooling Water Flow Rate (Mov.) Upper Limit",
  cooling_water_mov_lower_limit: "Cooling Water Flow Rate (Mov.) Lower Limit",
  cooling_water_sta: "Cooling Water Flow Rate (Sta.)",
  cooling_water_sta_upper_limit: "Cooling Water Flow Rate (Sta.) Upper Limit",
  cooling_water_sta_lower_limit: "Cooling Water Flow Rate (Sta.) Lower Limit",
  accel_point: "Accel. Point",
  accel_point_upper_limit: "Accel. Point Upper Limit",
  accel_point_lower_limit: "Accel. Point Lower Limit",
  deaccel_point: "Deaccel. Point",
  deaccel_point_upper_limit: "Deaccel. Point Upper Limit",
  deaccel_point_lower_limit: "Deaccel. Point Lower Limit",
  intensification_time: "Inten. Time",
  intensification_time_upper_limit: "Inten. Time Upper Limit",
  intensification_time_lower_limit: "Inten. Time Lower Limit",
  biscuit_thickness: "Biscuit Thickness",
  biscuit_thickness_upper_limit: "Biscuit Thickness Upper Limit",
  biscuit_thickness_lower_limit: "Biscuit Thickness Lower Limit",
  jet_cooling_pressure: "Jet Cooling Pressure",
  jet_cooling_pressure_upper_limit: "Jet Cooling Pressure Upper Limit",
  jet_cooling_pressure_lower_limit: "Jet Cooling Pressure Lower Limit",
  clamp_tonnage_he_low_pct: "Clamp Tonnage (HE.Low)",
  clamp_tonnage_he_low_pct_upper_limit: "Clamp Tonnage (HE.Low) Upper Limit",
  clamp_tonnage_he_low_pct_lower_limit: "Clamp Tonnage (HE.Low) Lower Limit",
  clamp_tonnage_he_low_mn: "Clamp Tonnage (HE.Low)",
  clamp_tonnage_he_low_mn_upper_limit: "Clamp Tonnage (HE.Low) Upper Limit",
  clamp_tonnage_he_low_mn_lower_limit: "Clamp Tonnage (HE.Low) Lower Limit",
  clamp_tonnage_op_up_pct: "Clamp Tonnage (OP.Up)",
  clamp_tonnage_op_up_pct_upper_limit: "Clamp Tonnage (OP.Up) Upper Limit",
  clamp_tonnage_op_up_pct_lower_limit: "Clamp Tonnage (OP.Up) Lower Limit",
  clamp_tonnage_op_low_pct: "Clamp Tonnage (OP.Low)",
  clamp_tonnage_op_low_pct_upper_limit: "Clamp Tonnage (OP.Low) Upper Limit",
  clamp_tonnage_op_low_pct_lower_limit: "Clamp Tonnage (OP.Low) Lower Limit",
  clamp_tonnage_he_up_pct: "Clamp Tonnage (HE.Up)",
  clamp_tonnage_he_up_pct_upper_limit: "Clamp Tonnage (HE.Up) Upper Limit",
  clamp_tonnage_he_up_pct_lower_limit: "Clamp Tonnage (HE.Up) Lower Limit",
  vacuum_pressure: "Vacuum Pressure",
  vacuum_pressure_upper_limit: "Vacuum Pressure Upper Limit",
  vacuum_pressure_lower_limit: "Vacuum Pressure Lower Limit",
...
const REPORT_UNITS = {
  ...
  die_close_core_in_time_upper_limit: "sec",
  die_close_core_in_time_lower_limit: "sec",
  pouring_time: "sec",
  pouring_time_upper_limit: "sec",
  pouring_time_lower_limit: "sec",
  shot_fwd_time: "sec",
  shot_fwd_time_upper_limit: "sec",
  shot_fwd_time_lower_limit: "sec",
  curing_time: "sec",
  curing_time_upper_limit: "sec",
  curing_time_lower_limit: "sec",
  die_open_core_out_time: "sec",
  die_open_core_out_time_upper_limit: "sec",
  die_open_core_out_time_lower_limit: "sec",
  ejector_time: "sec",
  ejector_time_upper_limit: "sec",
  ejector_time_lower_limit: "sec",
  extract_time: "sec",
  extract_time_upper_limit: "sec",
  extract_time_lower_limit: "sec",
  spray_time: "sec",
  spray_time_upper_limit: "sec",
  spray_time_lower_limit: "sec",
  v1_speed: "m/sec",
  v1_speed_upper_limit: "m/sec",
  v1_speed_lower_limit: "m/sec",
  v2_speed: "m/sec",
  v2_speed_upper_limit: "m/sec",
  v2_speed_lower_limit: "m/sec",
  v3_speed: "m/sec",
  v3_speed_upper_limit: "m/sec",
  v3_speed_lower_limit: "m/sec",
  v4_speed: "m/sec",
  v4_speed_upper_limit: "m/sec",
  v4_speed_lower_limit: "m/sec",
  metal_pressure: "MPa",
  metal_pressure_upper_limit: "MPa",
  metal_pressure_lower_limit: "MPa",
  furnace_metal_temp: "°C",
  furnace_metal_temp_upper_limit: "C",
  furnace_metal_temp_lower_limit: "C",
  cooling_water_mov: "L/min",
  cooling_water_mov_upper_limit: "L/min",
  cooling_water_mov_lower_limit: "L/min",
  cooling_water_sta: "L/min",
  cooling_water_sta_upper_limit: "L/min",
  cooling_water_sta_lower_limit: "L/min",
  accel_point: "mm",
  accel_point_upper_limit: "mm",
  accel_point_lower_limit: "mm",
  deaccel_point: "mm",
  deaccel_point_upper_limit: "mm",
  deaccel_point_lower_limit: "mm",
  intensification_time: "msec",
  intensification_time_upper_limit: "msec",
  intensification_time_lower_limit: "msec",
  biscuit_thickness: "mm",
  biscuit_thickness_upper_limit: "mm",
  biscuit_thickness_lower_limit: "mm",
...
function hasReportScanData(row = {}) {
  return Boolean(String(getRowValue(
    row,
    "scan_data",
    "part_scan_data",
    "part_qr_code",
...
export default function PlcReportPage({ onLogout, currentUser }) {
  ...
  }, [columns.length, fromDate, reportPage, searchText, selectedMachineId, shiftFilter, activeResultFilterValue, toDate]);
  const kpis = useMemo(() => {
    const counts = {
      ok: serverKpis.ok,
  ...
  const reportSearchLabel = searchText ? `${isGaugeReport || isLeakReport ? "Search" : "Shot"}: ${searchText}` : null;
  ...
  const filterGridClass = formIsGaugeReport
    ...
    : "grid gap-3 [grid-template-columns:repeat(auto-fit,minmax(150px,1fr))] 2xl:[grid-template-columns:minmax(160px,1fr)_minmax(165px,1fr)_minmax(145px,0.85fr)_minmax(125px,0.75fr)_minmax(145px,0.85fr)_minmax(145px,0.85fr)_minmax(115px,0.65fr)_minmax(220px,1.35fr)_minmax(105px,0.55fr)_minmax(120px,0.65fr)] 2xl:items-end";
  ...
  const reportFileBaseName = [
    ...
    searchText ? `search-${slugify(searchText)}` : null,
    fromDate,
    toDate,
  ].filter(Boolean).join("-");
          ...
          {filtersOpen && (
            <div className="border-t border-slate-200 p-3 sm:p-4">
              <div className={filterGridClass}>
                ...
                <label className="block">
                  <span className="text-xs font-extrabold uppercase tracking-[0.14em] text-slate-500">Search</span>
                  <input
                    type="search"
