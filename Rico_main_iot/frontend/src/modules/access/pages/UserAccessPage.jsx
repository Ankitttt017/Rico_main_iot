...
const ROLE_FALLBACKS = [
  ...
  },
  {
    ...
    landingPath: "/dashboard",
    permissions: ["master:view", "plc:view", "workstation:view", "downtime:view", "reports:view", "reports:export", "traceability:view", "ng:view"],
  },
  {
    ...
    permissions: ["plc:view", "workstation:view", "workstation:operate", "downtime:view", "downtime:manage", "reports:view", "traceability:view", "ng:view"],
  },
  {
    ...
    permissions: ["plc:view", "reports:view", "traceability:view", "ng:view"],
  },
  {
    key: "OPERATOR",
    label: "Operator",
