  ...
  return (
    <article className="group flex h-full flex-col rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-teal-300 hover:shadow-lg hover:shadow-slate-200/80">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        ...
        <div className="rounded-lg border border-slate-100 bg-slate-50 px-3 py-2">
          <p className="truncate text-sm font-extrabold text-slate-800">{line.division || "Department"}</p>
          <p className="mt-1 text-[10px] font-bold uppercase tracking-wide text-slate-400">Department</p>
        </div>
      </div>
      ...
      <div className="mt-3 min-h-[34px]">
        <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-extrabold text-slate-500">
          {line.plant_code || line.plant || "Plant"}
        </span>
      </div>
